...
- **ビジネス KPI 起点での開発経験**
  - 獲得コストと LTV を基点に、課金層と無課金層それぞれの収益施策を設計・実装
...
- 創業フェーズの株式会社ZENSHIN の CTO として、以下 6 つの業務を並行して推進
  - **[業務1] サービスの企画・立ち上げ**: 提供サービス 3 つとマッチング 2 サイトの公開
...
- **獲得コストと LTV を基点としたグロース施策**
  ...
  - 課金転換しない層は課金しない前提に置き、リワード広告・オファーウォールで広告収益化
- **高速な PDCA サイクルの実践**
