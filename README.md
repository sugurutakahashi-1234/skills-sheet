...
- **獲得コストと LTV を基点としたグロース施策**
  - 広告経由の獲得単価に課金 LTV が届かない状態を CEO と共有し、LTV を上げる施策を優先
  - ファネル分析で離脱ポイントを特定し、課金導線の改善によりサブスク契約者数と課金アイテム購入数を増加
  - ガチャ・ミッション機能・無料開放・オファーウォール連携を設計・実装し、ARPU と継続期間に反映
  - 回収の見込みが立った段階で、広告予算の増額や獲得単価の見直しの判断材料を提供
- **高速な PDCA サイクルの実践**
...
- 主担当はサーバーサイドチームで、手が空いたときや iOS チームの負荷が上がったときに兼任
