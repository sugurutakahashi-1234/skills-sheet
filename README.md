...
- **創業フェーズの CTO**
  - 技術選定・開発・運用から社内 IT まで、事業に必要なものを自分で決めて作る
  - 自社サービスの構想から、Web サイトでの見せ方までを設計
  - 小規模でも維持できる構成を選ぶ判断（Cloudflare 中心に寄せ、運用コストを抑制）
- **FDE（AI 活用の相談・提案〜実装・導入）**
...
- 創業フェーズの株式会社ZENSHIN の CTO として、以下 6 つの業務を並行して推進
  - **[業務1] AI 活用支援 / 提案活動（FDE）** — AI 活用の相談・提案から実装・導入まで支援
  - **[業務2] AI マッチングシステム開発** — Cloudflare での RAG / MCP / AI エージェント基盤
...
- **LINE 公式アカウント基盤（業務2）**
  ...
  - MCP 経由で AI エージェントが候補者に返信・提案を実行（人間の承認・監査記録付き）
...
- **自社サービスの立ち上げと見せ方の設計**
  - AI 活用伴走サービス・業務変革コンサルティング・スポット開発の立ち上げに参加
...
- **ビジネス指標に基づくグロース施策の企画・実装**
  ...
  - ガチャ・ミッション機能・無料開放施策の設計・実装を通じて、主要 KPI の改善に貢献
