...
- **デザイナーとの協業**
  ...
  - 文言、遷移方法、コンポーネントの色や配置など UI/UX の改善案を提案した
...
- チームの運用改善に積極的に取り組んだ
  ...
  - レトロスペクティブを実施した
  - 開発チーム朝ハドル会を実施した
  - プロダクトバックログを開発者が着手可能であることを表す「Ready」の概念を導入した
  - Pull Request 提出から Merge までの運用ルールを見直した
  - リリースブランチ運用を見直した
  - デイリー前の Slack リマインダーを設定した
  - デイリーでの相談事項の事前エントリー制を導入した
  - Firebase Crashlytics 運用を見直した
