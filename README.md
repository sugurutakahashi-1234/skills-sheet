...
- **所在**: 東京
- **現在のポジション**: FDE / CTO
  - **FDE**: 案件獲得の営業と AI 活用の相談・提案から、顧客の業務に入り込んだ AI ツールの実装・導入まで担当
...
- FDE として、案件獲得の営業・商談から AI 活用の提案、顧客向け AI ツールの実装・導入までを一気通貫で担当
...
- 2026年
  - [No.11] [株式会社ZENSHIN](https://www.zenshin-inc.co.jp/) - CTO（IT コンサルティング / SIer / SES）
    - 顧客向け AI 活用支援・AI ツール開発（FDE）/ 社内 AI システム開発 / コーポレートサイト・社内インフラ
